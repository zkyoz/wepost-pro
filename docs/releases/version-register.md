...
| `Unreleased`  | aucune                               | aucun                  | `develop` au `46b1032` plus PR [#23](https://github.com/zkyoz/wepost-pro/pull/23), correctif local `f0f581e`                                                                     | sécurité des dépendances, `BUG-022`, supervision, déploiement éphémère, documentation de maintenance et correctif local `SUP-001` |
...
- correctif local non encore livré :
